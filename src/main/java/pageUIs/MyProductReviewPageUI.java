...
public class MyProductReviewPageUI {
    ...
    public static final String RATING_VALUE = "xpath=//div[@class='product-review-item'][1]//div[@class='rating']/div";
    ...
    public static final String REVIEW_TEXT_VALUE = "xpath=//div[@class='product-review-item'][1]//div[@class='review-text']";
}
