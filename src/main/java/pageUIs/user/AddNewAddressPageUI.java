...
public class AddNewAddressPageUI {
    public static final String MY_ACCOUNT_ADD_NEW_ADDRESS_PAGE_TITLE = "xpath=//div[contains(@class,'address-edit-page')]//h1";
    ...
    public static final String STATE_PROVINCE_DROPDOWN = "xpath=//select[@id='Address_StateProvinceId']";
    public static final String CITY_TEXTBOX = "xpath=//input[@id='Address_City']";
    public static final String ADDRESS_1_TEXTBOX = "xpath=//input[@id='Address_Address1']";
    public static final String ADDRESS_2_TEXTBOX = "xpath=//input[@id='Address_Address2']";
    public static final String ZIP_POSTAL_CODE_TEXTBOX = "xpath=//input[@id='Address_ZipPostalCode']";
    public static final String PHONE_NUMBER_TEXTBOX = "xpath=//input[@id='Address_PhoneNumber']";
    public static final String FAX_NUMBER_TEXTBOX = "xpath=//input[@id='Address_FaxNumber']";
