...
public class BaseActionPageUI {
    ...
    public static final String DYNAMIC_HEADER_UPPER_MENU_LINK_BY_CLASS = "xpath=//a[@class='%s']";
    ...
    public static final String DYNAMIC_CHECKBOX_OR_RADIO_BUTTON_BY_LABEL_NAME = "xpath=//label[text()='%s']/preceding-sibling::input";
    ...
    public static final String DYNAMIC_TABLE_ROW_VALUE_BY_HEADER_INDEX = "xpath=//table[@class='cart']//tbody//td[%s][contains(string(),'%s')]";
}
